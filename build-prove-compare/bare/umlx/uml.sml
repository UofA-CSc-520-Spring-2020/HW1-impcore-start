...
(* definition of [[validate]], for the types of the value constructors of [[T]] S297 *)
   ...
   (* for [[K]], complain that [[alphas]] is inconsistent with [[kind]] S330b *)
      ...
      val _ = op validateLengths       : tyvar list * kind list -> unit
        in
(* validation by case analysis on [[schemeShape shape]] and [[kind]] ((existentials)) S331a *)
...
(* function [[literal]], to infer the type of a literal constant ((adt)) S303b *)
      (* definition of function [[pvconType]] ((existentials)) S309c *)
      ...
      fun choicetype ((p, e), Gamma) =
            let val (Gamma', tau, c) = pattype (p, Gamma)
                ...
                val _ =
(* check [[p]], [[e]], [[Gamma']], [[Gamma]], [[ty]], and [[con]] for escaping skolem types ((existentials)) S310a *)
            ...
            (* definitions of skolem functions [[fail]] and [[badType]] S310d *)
                            fun fail ss =
                        ...
                        in  case (inter (patSkolems, tySkolems), inter (
                              ...
                              of (mu :: _,  _) =>
                                 (* fail with skolem escaping into type S310b *)
                               ...
                               | ([], mu :: _) =>
                          (* fail with skolem escaping into environment S310c *)
                                                  fail ["skolem type " ^
