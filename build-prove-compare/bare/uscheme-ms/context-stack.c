...
/* context-stack.c S190a */
void clearstack (Stack s) {
    s->sp = s->frames;
}
/* context-stack.c S190c */
...
/* context-stack.c S190d */
static Frame *pushframe (Frame f, Stack s) {
    assert(s);
    /* if stack [[s]] is full, enlarge it S190e */
    ...
    *s->sp++ = f;
    /* set [[high_stack_mark]] from stack [[s]] S192f */
    {   int n = s->sp - s->frames;
