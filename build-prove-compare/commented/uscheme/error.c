 ...
 * 
 *   • In normal mode, it prints a message, then jumps
 *  to [[errorjmp]].
 *   • In testing mode, it buffers the message, then
 *  silently jumps to [[testjmp]].
 * 
 * [*] \implabelrunerror [*]
 * <error.c>=
 */
...
/*
 * Function [[set_toplevel_error_format]] sets the error
 * format used for standard input.
 * <error.c>=
 */
