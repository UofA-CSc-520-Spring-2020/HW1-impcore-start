...
val _ = finiteStreamOfLine :
          (unit -> string option) -> 't lexer * ('t, 'a) polyparser -> line ->
                                                                       'a stream
(* Supporting code for uProlog                  *)
(*                                              *)
(* [*][*]                                       *)
(*                                              *)
(* \invisiblelocaltableofcontents[*] This Appendix is *)
(* longer than many others:                     *)
(*                                              *)
(*   • Even Prolog's simple syntax requires more code to *)
(*  parse than prefix-parenthesized syntax.     *)
(*   • In uProlog, as in C, a comment can span multiple *)
(*  lines, which means its lexical analyzer has to *)
(*  track source-code locations. This tracking needs *)
(*  extra code.                                 *)
(*   • A uProlog interpreter has two modes: rule mode *)
(*  and query mode. Tracking modes introduces   *)
(*  additional complexity.                      *)
(*                                              *)
(* Substitution                                 *)
(*                                              *)
(* [*] A substitution \subsn is a structure-preserving *)
(* mapping from terms to terms. As in \crefml.chap, *)
(* we represent a substitution as an environment. *)
(* The environment maps logical variables to terms. *)
(* All the substitution functions resemble the functions *)
(* used to substitute types for type varibles in \cref *)
(* ml.chap.                                     *)
