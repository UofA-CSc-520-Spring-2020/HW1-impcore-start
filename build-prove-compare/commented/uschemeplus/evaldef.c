 ...
 * 
 * The function [[evaldef]] evaluates a true definition,
 * updates the store, and returns a new environment. If
 * [[echo]] is [[ECHOES]], [[evaldef]] also prints.\
 * scmflabelevaldef There is no [[RECORD]] case: the
 * [[record]] form is syntactic sugar, not a true
 * definition.
 * <evaldef.c>=
 */
    ...
    case VAL:
         ...
         */
        {
            ...
            *find(d->u.val.name, env) = v;
            /*
             * <if [[echo]] calls for printing, print either [[v]] or the bound
                                                                          name>=
             */
            if (echo == ECHOES) {
