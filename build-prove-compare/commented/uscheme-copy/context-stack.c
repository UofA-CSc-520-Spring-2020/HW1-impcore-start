#include "all.h"
/*
 * which was obtained by replacing the occurrence of fac
 * in the definition of fac by that definition. To make
 * this clearer, apply the inner lambda to its argument
 * symbolically, giving:
 * 
 * <context-stack.c>=
 */
